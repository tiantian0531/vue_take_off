    ...
    <div class="news">
      <ul>
        <li v-for="news in newsList">
          <!-- <RouterLink :to="{path:'/news/detail'}" active-class="xiaozhupeiqi" >{{s.title}}</RouterLink> -->
          <!-- <RouterLink :to="`/news/detail?a=1&b=2&c=${s.id}`" active-class="xiaozhupeiqi" >{{s.title}}</RouterLink> -->
